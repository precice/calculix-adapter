...
!
      subroutine calcrhofa1(vfa,rhcon,nrhcon,ielmat,ntmat_,
     &  ithermal,mi,ielfa,nfacea,nfaceb)
!
...
!
      implicit none
!
      integer i,nrhcon(*),imat,ithermal,ntmat_,mi(*),
     &  ielmat(mi(3),*),ielfa(4,*),nfacea,nfaceb
!
      real*8 t1l,vfa(0:7,*),rhcon(0:1,ntmat_,*) 
!
      intent(in) rhcon,nrhcon,ielmat,ntmat_,
     &  ithermal,mi,ielfa,nfacea,nfaceb
!
      intent(inout) vfa
!     
