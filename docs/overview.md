...
- preCICE v1 was supported in the branches `v2.10`, `v2.12`, `v2.13`, and `v2.15`.
...
1. Lucia Cheung Yau. Conjugate heat transfer with the multiphysics coupling library preCICE. Master’s thesis, Department of Informatics, Technical University of Munich, 2016. [URL: MediaTUM](https://mediatum.ub.tum.de/1461907)
2. Benjamin Uekermann, Hans-Joachim Bungartz, Lucia Cheung Yau, Gerasimos Chourdakis and Alexander Rusch. Official preCICE Adapters for Standard Open-Source Solvers. In Proceedings of the _7th GACM Colloquium on Computational Mechanics for Young Scientists from Academia_, 2017. [DOI: 10.18419/opus-9334](https://doi.org/10.18419/opus-9334)
